...
alias fixscreen='xrandr --output VGA-1 --mode 1366x768'
...
# SSH
alias Anarchia='echo "Not available"'
alias Anarchia='echo "Not available"'
alias L-get='echo not available /path/to/host/file ~/path/to/destination && scp '

## Stress test
alias Stress='systester-cli -gausslg 64M -threads 4'

## DEs
alias Cinnamon='sudo ~/git/dotfiles_desktop/Scripts/cinnamon.sh'
alias Awesome='sudo ~/git/dotfiles_desktop//Scripts/awesome.sh'
...
## Conky
# Awesome conky
alias cdC23='cd ~/.config/awesome/conky'
alias eC23='cd ~/.config/awesome/conky && vim conkyrc'
...
alias Default='/home/x1ce/Scripts/Theming/default.sh'
alias 1080='/home/x1ce/Scripts/Theming/1080.sh'
alias 1440='/home/x1ce/Scripts/Theming/1440.sh'
...
source /home/x1ce/.oh-my-zsh/oh-my-zsh.sh
